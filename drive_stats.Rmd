...
## Defense Drives
```{r, echo= FALSE, warning=FALSE, message = FALSE}
UVADefGamePlay <- DefenseDriveDataFrame %>% filter(DefTeamName == "Virginia" & game_id == "18078") %>% select(drive, NewFPos, Plays, Yards, YPP, Efficiency, FirstDowns, BigPlays, Havoc, drive_end_event, FirstDownEfficiency, SecondDownEfficiency, ThirdDownEfficiency, ScoringOpportunity) %>%
